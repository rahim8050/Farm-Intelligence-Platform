...
* Locked in the **Nextcloud integration strategy** for `farm-intelligence-platform`:

  * Nextcloud app acts as a **thin authenticated proxy/UI**
  * Server-side calls from Nextcloud → `farm-intelligence-platform` (no CORS pain, no secret leakage to browser)
...
* Begin Nextcloud MVP:
  ...
  * add one controller route that calls `farm-intelligence-platform` server-side
...
* Repo: `https://github.com/rahim8050/farm-intelligence-platform`
* PR(s): —
* Commit(s): —
* Issue(s): —
