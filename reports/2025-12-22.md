...
* Planning the integration path for **Nextcloud APIs** to consume `farm-intelligence-platform` endpoints cleanly (auth, base URL, error handling, retries/timeouts).

## Next

* Scaffold the **Nextcloud app / API client layer** to consume `farm-intelligence-platform`:
